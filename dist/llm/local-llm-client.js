...
class LocalLLMClient {
    ...
    async initializeOllama() {
        ...
        if (!await this.checkOllamaAvailable()) {
            ...
            this.modelProcess = (0, child_process_1.spawn)('ollama', ['serve'], {
                detached: true,
                stdio: 'ignore'
            });
    ...
    async ensureOllamaModel(modelName) {
        try {
            ...
            if (!modelExists) {
                ...
                await new Promise((resolve, reject) => {
                    const pullProcess = (0, child_process_1.spawn)('ollama', ['pull', modelName], {
                        stdio: 'inherit'
                    });
    ...
    async initializeLlamaCpp() {
        ...
        this.modelProcess = (0, child_process_1.spawn)(serverPath, args, {
            stdio: 'pipe'
        });
    ...
    async initializeVLLM() {
        ...
        if (!await this.checkVLLMAvailable()) {
            ...
            this.modelProcess = (0, child_process_1.spawn)('python', args, {
                stdio: 'pipe',
                env
            });
            this.modelProcess.stdout?.on('data', (data) => {
...
`;
        ...
        this.modelProcess = (0, child_process_1.spawn)('python', [scriptPath], {
            stdio: 'pipe',
            env
        });
        this.modelProcess.stdout?.on('data', (data) => {
