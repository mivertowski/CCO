...
Respond in JSON format with the following structure:
{
  ...
  "confidence": 0.0-1.0
    ...
    buildAnalysisUserMessage(mission, session, progress) {
        return `
...
- Validation steps`;
    ...
    buildPlanningUserMessage(analysis, criterion, session) {
        return `
Current Analysis:
...
Respond in JSON format:
{
  ...
  "confidence": 0.0-1.0
    ...
    buildValidationUserMessage(criterion, executionResult, _session) {
        return `
...
Determine if this criterion has been successfully completed.`;
    ...
    buildErrorRecoverySystemPrompt() {
...
Respond in JSON format:
{
  ...
  "reason": "Why recovery is/isn't possible"
    ...
    buildErrorRecoveryUserMessage(error, session) {
        return `
Error encountered:
- Type: ${error.name}
...
Analyze this error and provide a recovery strategy.`;
    ...
    parseErrorRecoveryResponse(content) {
        try {
            const jsonMatch = content.match(/\{[\s\S]*\}/);
            if (jsonMatch) {
                return JSON.parse(jsonMatch[0]);
...
exports.ManagerLLM = ManagerLLM;
//# sourceMappingURL=manager-llm.js.map